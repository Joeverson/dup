...
<style>
    .layout-transparent {
        background: linear-gradient(RGBA(28, 28, 28, 0.45), RGBA(28, 28, 28, 0.45)), url('<?=$endereco ?>includes/img/lendo.jpg') center / cover;
    }
    ...
    <header class="mdl-layout__header mdl-layout__header--transparent">
        <div class="mdl-layout__header-row">
            ...
            <span class="mdl-layout-title">
                <a href="<?= $endereco ?>../admin"><img src="<?= $endereco ?>includes/img/iena.png" width="140" alt=""/></a>
            </span>
