...
<style>
    .layout-transparent {
        background: linear-gradient(RGBA(28, 28, 28, 0.45), RGBA(28, 28, 28, 0.45)), url('<?=$endereco ?>includes/img/<?=$slider->getSliderForType(1)['url']?>') center / cover;
    }
...
<div class="layout-transparent mdl-layout mdl-js-layout">
        ...
        <div class="mdl-layout__header-row">
            ...
            <span class="mdl-layout-title">
                <a href="<?= $endereco ?>../admin">
                    <img src="<?= $endereco ?>includes/img/bulll.png" width="60" alt=""/>
                </a>
            </span>
    ...
    <div class="mdl-layout__drawer">
        <span class="mdl-layout-title">
            <a href="<?= $endereco ?>../admin">
                <img src="<?= $endereco ?>includes/img/bulll.png" width="100" alt=""/>
            </a>
        </span>
        <nav class="mdl-navigation">
